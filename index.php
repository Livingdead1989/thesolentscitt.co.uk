    ...
    <section id="hp-qlandpromo" class="row" data-equalizer data-equalize-on="large" id="hp-qlandpromo">
      <div class="large-6 columns" data-equalizer-watch>
        <div class="hp-slogan-container">
          <blockquote class="hp-slogan"><small>Become a teacher and join the best profession in the world. <br>Learn from real teachers in real classrooms.<br> <a href="/assets/learn-more.pdf" style="color: black;">Learn more about teacher training with The Solent SCITT</a></small><br></blockquote>
        </div>
      ...
      <div class="large-6 columns hp-promovid" data-equalizer-watch>
        <div class="flex-video">
          <iframe src="https://www.youtube-nocookie.com/embed/vFkOW1q59aI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
    </section>
