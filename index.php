    ...
    <section id="hp-qlandpromo" class="row" data-equalizer data-equalize-on="large" id="hp-qlandpromo">
      <div class="large-6 columns" data-equalizer-watch>
        <div class="hp-slogan-container">
          ...
          <blockquote class="hp-slogan"><br><small>Calling all graduates working as unqualified teachers. <br>Gain QTS in 2019/20 via our <a style="color:white; text-decoration:underline;" href="/assessmentonly.php">Assessment Only</a> Route.</small><br><br></blockquote>
        </div>
