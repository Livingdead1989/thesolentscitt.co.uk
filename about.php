...
<html class="no-js" lang="en" dir="ltr">
  <head>
    ...
    <title>The Solent SCITT | About Us</title>
  </head>
  <body>
    <!-- TOPNAV -->
          ...
          <div class="small-up-2 medium-up-3 large-up-5 team-container">
            ...
            <div class="large reveal" id="exampleModalharrison" data-reveal>
              ...
              <div class="small-4 column">
                <img class="modal-profile-img circle" src="images/team/Clare.jpg" alt="">
              </div>
            ...
            <!-- MODAL 2 -->
            <div class="large reveal" id="exampleModalseery" data-reveal>
              <div class="small-8 column">
                <h2>Phil Seery</h2>
                <p class="lead">Qualifications</p>
              ...
              <div class="small-4 column">
                <img class="modal-profile-img circle" src="images/team/Phil.jpg" alt="">
              </div>
              <button class="close-button" data-close aria-label="Close modal" type="button">
                <span aria-hidden="true">&times;</span>
              </button>
            ...
            <!-- MODAL 3 -->
            <div class="large reveal" id="exampleModalmillet" data-reveal>
              <div class="small-8 column">
                <h2>Gill Millet</h2>
                <p class="lead">Qualifications</p>
              ...
              <div class="small-4 column">
                <img class="modal-profile-img circle" src="images/team/Gill.jpg" alt="">
              </div>
              <button class="close-button" data-close aria-label="Close modal" type="button">
                <span aria-hidden="true">&times;</span>
              </button>
            ...
            <!-- MODAL 4 -->
            <div class="large reveal" id="exampleModallowe" data-reveal>
              <div class="small-8 column">
                <h2>Jackie Lowe</h2>
                <p class="lead">Qualifications</p>
                <p>BA (Hons), MA (Ed): Warblington School</p>
                <p>Jackie is one of the Solent SCITT’s three coordinators with experience of initial teacher training. Jackie started her career as a fashion designer working in luxury menswear and then running her own design business. After having children, she decided to change career and teach design technology to inspire the next generation.</p>
