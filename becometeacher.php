...
<html class="no-js" lang="en" dir="ltr">
  <head>
    ...
    <title>The Solent SCITT | Becoming a Teacher</title>
  </head>
  <body>
    <!-- TOPNAV -->
    ...
    <section class="row" id="whybecometeacher">
      <div class="columns">
        ...
        <div class="small-8 small-push-2">
          <br>
          <img src="images/scitt08.jpg" alt="Science bursaries helped graduates train to teach in Hampshire with the SCITT.">
          <br><br>
        </div>
        ...
        <ul class="vertical menu" data-accordion-menu>
          <li>
            ...
            <ul class="menu vertical nested">
              <ul>
                <li>You must hold a degree of a UK university, higher education institution or an acceptable equivalent at 2.2 or above.</li>
...
<section class="row" id="howbecometeacher">
  <div class="columns">
        ...
        <p><strong>Visa to Study:</strong></p>
        <p>If you are from a non-EU country, then you must hold an appropriate visa stating that you are eligible to study in the UK for the duration of the course. Unfortunately, the Solent SCITT is not able to provide sponsorship for a Visa.</p>

        <p><strong>Previous experience in a school setting:</strong></p>
...
<!-- Quote End -->
  ...
  <section class="row">
    <div class="column">
      ...
      <p>The Solent SCITT has been developed through years of collaboration with our partnership schools and Portsmouth University to offer a school-based, high-quality, cross-phase and coherent bespoke training programme, which is adapted to your individual needs. We are located in South East Hampshire in The Dickinson Centre, a professional training facility attached to Park Community School in close proximity to other local schools, giving trainees an excellent experience across a variety of partnership providers.</p>
